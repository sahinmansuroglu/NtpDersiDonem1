...
2. [``` Metotları değer ile çağırma (call by value), referans ile çağırma(call by reference)```](https://github.com/sahinmansuroglu/NtpDersi/blob/main/9_Hafta_Ders_2.md)
3. [``` Metotlarda ref ve out Kullanımı ```](https://github.com/sahinmansuroglu/NtpDersi/blob/main/9_Hafta_Ders_3.md)
